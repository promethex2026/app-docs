...
<Warning>
The `userOperation` must be properly constructed and signed via ERC-4337. See the [Authentication](/api-reference/authentication) page for details on signing.
</Warning>
