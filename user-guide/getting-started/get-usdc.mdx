...
<Steps>
  ...
  <Step title="Connect MetaMask to PrometheX">
    Go to [app.promethex.market](https://app.promethex.market), click **Sign In** → **Connect Wallet** → select **MetaMask**.
  </Step>
</Steps>
...
<a href="https://faucet.promethex.market" target="_blank" style={{display:'inline-block',padding:'12px 24px',background:'linear-gradient(135deg,#6366f1,#8b5cf6)',color:'#fff',borderRadius:'10px',fontWeight:600,textDecoration:'none',fontSize:'15px'}}>
  Open Faucet
</a>

<Steps>
  <Step title="Open the faucet page">
    Visit the [PrometheX Faucet](https://faucet.promethex.market) and click **Connect MetaMask**. Approve the connection in MetaMask.
  </Step>
...
<Steps>
  <Step title="Open your wallet on PrometheX">
    Go to [app.promethex.market](https://app.promethex.market). Make sure you're signed in with your MetaMask wallet. Click your **profile icon** → **Wallet**.
  </Step>
  ...
  <Step title="Approve and confirm">
    ...
    <img src="/images/user-guide/trade-panel.png" alt="PrometheX trading interface" style={{maxWidth:'480px',borderRadius:'12px',marginTop:'12px'}} />
    </Warning>
  </Step>
  <Step title="Start trading">
    Once confirmed, your balance updates on PrometheX. Head to the [Markets](https://app.promethex.market) page to place your first trade!
  </Step>
</Steps>
...
**tUSDC Contract:** [`0x52cb113e383c654fB78Ff56615ce3719193C6408`](https://sepolia.arbiscan.io/address/0x52cb113e383c654fB78Ff56615ce3719193C6408)

<Steps>
  <Step title="Open the Write Contract page">
    Go to the [tUSDC Write Contract page on Arbiscan](https://sepolia.arbiscan.io/address/0x52cb113e383c654fB78Ff56615ce3719193C6408#writeContract).
  </Step>
