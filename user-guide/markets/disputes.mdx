...
<AccordionGroup>
  ...
  <Accordion title="What if I disagree but don't want to post a bond?">
    If you see an outcome you think is wrong but don't want to risk a bond, you can raise the issue in the PrometheX community on [Discord](https://discord.com/invite/EuKaZNwARB). Someone who agrees with you may be willing to file the dispute.
  </Accordion>
