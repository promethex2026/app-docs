...
<Frame>
  <img src="/images/user-guide/trade-panel.png" alt="PrometheX buy interface showing outcome selection, amount input, and potential payout" style={{borderRadius:'12px',maxWidth:'600px'}} />
</Frame>
