...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------ | :------: | :----: |
| **Test USDC** (tUSDC) | [`0x1A8da4723A4f7aD0A965cb3dBC31c72435b1B490`](https://sepolia.arbiscan.io/address/0x1A8da4723A4f7aD0A965cb3dBC31c72435b1B490) | 6        | Active |
...
<CardGroup cols={2}>
  <Card icon="file-contract" href="/contracts/overview" title="Contract Overview">
