...
<Card icon="rocket" href="https://app.promethex.market" title="Launch Staging App">
  Open the live staging environment at **app.promethex.market** — sign in, get test USDC, and place your first trade in under a minute.
</Card>
...
<Steps>
  <Step title="Open the staging app">
    Navigate to [app.promethex.market](https://app.promethex.market) in your browser.
  </Step>
  <Step title="Sign in">
  ...
  <Step title="Get test USDC">
    Use the in-app faucet to receive tUSDC, or mint directly from the [tUSDC contract](0x52cb113e383c654fB78Ff56615ce3719193C6408). Test tokens have no real value.
  </Step>
...
| **Direct mint**   | Call `mint()` on the [tUSDC contract](0x52cb113e383c654fB78Ff56615ce3719193C6408) |
