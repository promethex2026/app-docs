...
<Card title="Launch Staging App" icon="rocket" href="https://staging.promethex.market">
...
<Steps>
  ...
  <Step title="Get test USDC">
    Use the in-app faucet to receive tUSDC, or mint directly from the [tUSDC contract](https://sepolia.arbiscan.io/address/0x934E616cA9538397E3f9a12895C40ea2E8C45E48). Test tokens have no real value.
  </Step>
...
| **Direct mint** | Call `mint()` on the [tUSDC contract](https://sepolia.arbiscan.io/address/0x934E616cA9538397E3f9a12895C40ea2E8C45E48) |
